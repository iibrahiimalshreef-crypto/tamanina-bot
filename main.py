...
# ID حسابك المباشر للإحصائيات والصلاحيات المطلقة
ADMIN_ID = 8955520748
...
# =========================================================
# 6. التحقق من صلاحيات المستخدم (مع استثناء ADMIN_ID)
# =========================================================

async def is_authorized_to_manage(chat, user_id, bot):
    # السماح لك أنت شخصياً بصفتك صاحب البوت بالتحكم في أي قروب
    if user_id == ADMIN_ID:
        return True
...
# =========================================================
# 9. إرسال الذكر الدوري (تغليظ النص وزر "شارك الأجر")
# =========================================================
