...
ATHKAR_LIST = [
    ...
    "اللَّهُمَّ آتِ نُفُوسَنَا تَقْوَاهَا، وَزَكِّهَا أَنْتَ خَيْرَ مَنْ زَكَّاهَا، أَنْتَ وَلِيُّهَا وَمَوْلاهَا."
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "⚙️ للتحكم بالإعدادات والتكرار، أرسل:\n"
        "/settings",
        parse_mode="Markdown"
    )
...
async def settings(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"• *بداية ساعات العمل:* "
        f"{config.get('start_hour', 5)}:00\n"
        f"• *نهاية ساعات العمل:* "
        f"{config.get('end_hour', 2)}:00\n\n"
...
async def button_callback(
    ...
    if data.startswith("set_int_"):
        ...
        await query.edit_message_text(
            f"✅ تم تغيير معدل الإرسال إلى:\n\n"
            f"*كل {interval} ساعة/ساعات*",
            parse_mode="Markdown"
        )
...
# =========================================================
# 8. المجدول الرئيسي - توقيت الرياض
# =========================================================
...
async def master_scheduler(application):
    ...
    while True:
        ...
        # الانتظار دقيقة قبل الفحص التالي
        await asyncio.sleep(60)


# =========================================================
# 9. تشغيل المجدول بعد تشغيل البوت
# =========================================================
